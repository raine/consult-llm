...
pub struct ProviderSpec {
    ...
    /// Env var selecting the provider name passed to Pi.
    pub pi_provider_env: &'static str,
    /// Default Pi provider for this model family.
...
pub static PROVIDERS: &[ProviderSpec] = &[
    ProviderSpec {
        ...
        pi_provider_env: "CONSULT_LLM_PI_GEMINI_PROVIDER",
    ...
    ProviderSpec {
        ...
        pi_provider_env: "CONSULT_LLM_PI_DEEPSEEK_PROVIDER",
    ...
    ProviderSpec {
        ...
        pi_provider_env: "CONSULT_LLM_PI_OPENAI_PROVIDER",
    ...
    ProviderSpec {
        ...
        pi_provider_env: "CONSULT_LLM_PI_MINIMAX_PROVIDER",
    ...
    ProviderSpec {
        ...
        builtin_models: &["claude-opus-5", "claude-opus-4-7"],
        selector_priorities: &["claude-opus-5", "claude-opus-4-7"],
        ...
        pi_provider_env: "CONSULT_LLM_PI_ANTHROPIC_PROVIDER",
    ...
    ProviderSpec {
        ...
        builtin_models: &["grok-4.6", "grok-4.5", "grok-4.3"],
        selector_priorities: &["grok-4.6", "grok-4.5", "grok-4.3"],
        ...
        pi_provider_env: "CONSULT_LLM_PI_GROK_PROVIDER",
    ...
    ProviderSpec {
        ...
        pi_provider_env: "CONSULT_LLM_PI_OPENROUTER_PROVIDER",
    ...
    ProviderSpec {
        ...
        pi_provider_env: "CONSULT_LLM_PI_ZAI_PROVIDER",
...
mod tests {
    ...
    fn registry_integrity() {
        ...
        for spec in PROVIDERS {
            ...
            assert!(!spec.pi_provider_env.is_empty());
            assert!(!spec.default_pi_provider.is_empty());
            assert!(
                spec.allowed_backends.contains(&"pi"),
                "provider {:?} must allow Pi backend",
                spec.id
            );
            assert!(
