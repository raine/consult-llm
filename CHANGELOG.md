...
- `consult-llm` now owns and embeds its CLI reference skill plus the complete `llm-*` workflow-skill family, with deterministic list, print, version discovery, and safe multi-agent installation commands.
